...
export default function Home() {
  return (
    <Container maxW={'7xl'} py={12} px={{ base: 4, md: 10 }}>
      <Box
        maxW="120rem"
        marginX="auto"
...
export const featuresList = [
  {
    id: 1,
    title: 'Mision',
    desc: `Nuestra misión es conectar a estudiantes y profesionales con oportunidades de aprendizaje innovadoras y relevantes para su crecimiento y desarrollo en su carrera. Ofrecemos una plataforma en línea accesible y fácil de usar para encontrar, inscribirse y participar en eventos educativos de calidad.`,
    icon: (
      <svg
  ...
  },
  {
    id: 2,
    title: 'Vision',
    desc: `Queremos ser la plataforma líder en eventos académicos, proporcionando oportunidades de aprendizaje en línea y presenciales de la más alta calidad, accesibles para todos los interesados en continuar su educación y mejorar sus habilidades en cualquier campo.`,
    icon: (
      <svg
        style={{ width: '2rem', height: '2rem' }}
        viewBox="0 0 24 24"
  ...
  },
  {
    id: 3,
    title: 'Objetivo',
    desc: `Ofrecer una amplia variedad de eventos educativos para satisfacer las necesidades de estudiantes y profesionales de diferentes áreas y niveles de conocimiento.`,
    icon: (
      <svg
        style={{ width: '2rem', height: '2rem' }}
        viewBox="0 0 24 24"
